# TASK 1 "stay alive"numbers = [4, 8, 15, 16, 23, 42]
# here we use massive and create peremennayafor number in numbers:
    print(number, end=" ")
   # 2
for number in numbers:    print(number)
# 3
    # num = int(input("Enter a number: "))    # print(num, num + 1, num + 2)

#4    # num1 = int(input("Enter the first integer: "))
    # num2 = int(input("Enter the second integer: "))    # num3 = int(input("Enter the third integer: "))
...
print("Total surface area =", int(tsa))
    # TASK 2
    #1    qwe = int(input("Enter the number of schoolchildren: "))
    tangerines = int(input("Enter the number of tangerines: "))    tang = tangerines // qwe
    remaind = tangerines % qwe    print(tang)
    print(remaind)
    #2    NUM = int(input("Enter a four-digit number: "))
    thousand = (NUM // 1000) % 10    hundred = (NUM // 100) % 10
    ten = (NUM // 10) % 10    unit = NUM % 10
    print("The digit in the thousands position is", thousand)    print("The digit in the hundreds position is", hundred)
    print("The digit in the tens position is", ten)    print("The digit in the units position is", unit)
    #3
